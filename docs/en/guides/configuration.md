...
Project Codex and opencode installations share the managed `AGENTS.md` routing
block and the `.agent-ops/AGENTS.md` rules artifact. Opencode additionally gets
